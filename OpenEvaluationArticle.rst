...
1. Distribute reviews to many reviewers.\ :sup:``[h] <#cmnt8>`_`\ 
...
held responsible every\ :sup:``[i] <#cmnt9>`_`\  aspect of the article,
...
lessen burden\ :sup:``[j] <#cmnt10>`_`\  placed on any one reviewer,
...
article’s methods section.\ :sup:``[l] <#cmnt12>`_`\ 
...
pnas.org\ :sup:``[m] <#cmnt13>`_`\ ) are now mandating submitting all
...
are participating in the review.\ :sup:``[o] <#cmnt15>`_`\ 
