...
necessary to replicate the results of a study. Such systems will allow
the community to acknowledge reviewer contributions, quantify the
quality of their contributions, and ensure that the review process is
both timely and enduring beyond the publication date. We demonstrate
that technology currently available in open code review systems support
this framework.
...
anonymous and unpublished opinions combining power and secrecy. After
